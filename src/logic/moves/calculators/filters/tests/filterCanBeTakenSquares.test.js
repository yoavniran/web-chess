...
describe("filterCanBeTakenSquares tests", () => {
	...
	it.each([
		...
		["1r1r4/1pkp4/3n4/8/5B2/1RR1B3/8/8 w - - 0 1", "C7", 3, ["B8","D8","D7",], ["B6","C6", "C8", "D5"]],
		...
		(fen, startSquare, count, allowedSquares, notAllowed) => {
			...
			console.log("king moves = ", kingMoveSquares);

			const filtered = filterCanBeTakenSquares(PIECE_COLORS.WHITE, kingMoveSquares, state);
